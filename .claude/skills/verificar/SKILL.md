...
3. **Build completo** — `npm run build` → leer TODO el final de la salida, nunca solo
...
- ✅ **Listo para push** — los 3 pasos limpios.
- 🚨 **NO subir** — decir exactamente qué paso falló y el error, y arreglarlo antes.

## Reglas

- **NUNCA `git push` con cualquiera de los 3 pasos fallando.**
